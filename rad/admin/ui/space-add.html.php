...
<div class="card border-0 shadow-sm mb-4 bg-body-tertiary">
    <div class="card-body p-4">
        <div class="row g-3 align-items-start">
            <div class="col-lg-8">
                <div class="text-uppercase text-muted small fw-semibold mb-2">Workspace Creation</div>
                <h2 class="h3 mb-2">Create a new workspace with clean metadata</h2>
                <p class="text-muted mb-0">Start with a clear name, stable slug, optional owner, and a valid JSON definition so follow-up membership and permission work stays predictable.</p>
            </div>
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm-sm h-100">
                    <div class="card-body">
                        <div class="fw-semibold mb-2">Recommended defaults</div>
                        <ul class="small text-muted mb-0 ps-3">
                            <li>Keep status as Active unless provisioning is incomplete.</li>
                            <li>Leave slug blank to auto-generate from the workspace name.</li>
                            <li>Assign an owner later if you do not have the user ready yet.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="form-text">Human-readable name used throughout RAD Admin and the workspace shell.</div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Lowercase, URL-friendly, and generated automatically if left blank.</div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Optional. You can assign an owner later from the workspace detail screen.</div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="form-text">Short summary for operators who scan the list and detail pages.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div class="form-text mt-2">Valid JSON only. Workspace-specific DYN and other advanced settings live here.</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="d-flex flex-wrap gap-2">
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-check-circle me-1"></i>Create Workspace
            </button>
            <a href="<?php echo htmlspecialchars($radAdminUrl . '/space/view'); ?>" class="btn btn-outline-secondary">
