...
class PrivilegeService {
    ...
    private function defaultManifest(): array {
        return [
            ...
            'code_assist_chat' => ['system_admin', 'developer'],
            'source_read' => ['system_admin', 'developer'],
            'source_write' => ['system_admin', 'developer'],
            'sql_read' => ['system_admin', 'developer'],
            'code_execute' => ['system_admin'],
